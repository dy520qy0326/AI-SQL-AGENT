            ...
            {filtered.map((p) => (
              <div key={p.id} className="relative group">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 rounded p-1 text-gray-300 opacity-0 transition hover:text-red-500 group-hover:opacity-100 cursor-pointer"
                  title="删除项目"
                >
          ...
          {data && data.total > size && (
            <div className="mt-6 flex items-center justify-center gap-2 text-sm">
              <button
                ...
                className="rounded border px-3 py-1 disabled:opacity-30 cursor-pointer disabled:cursor-not-allowed"
              >
                上一页
              </button>
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            <h3 className="mb-4 text-lg font-semibold text-gray-900">新建项目</h3>
